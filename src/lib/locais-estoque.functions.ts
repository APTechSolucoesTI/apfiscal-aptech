...
export const listLocaisEstoque = createServerFn({ method: "GET" })
...
export const saveLocalEstoque = createServerFn({ method: "POST" })
  .middleware([requireSupabaseAuth])
...
export const toggleLocalEstoqueAtivo = createServerFn({ method: "POST" })
  .middleware([requireSupabaseAuth])
...
export const deleteLocalEstoque = createServerFn({ method: "POST" })
  .middleware([requireSupabaseAuth])
