...
import { useNavigate, useSearch, Link } from "@/lib/router-compat";
...
export default function Login() {
  return (
    <Suspense fallback={<div className="flex min-h-screen items-center justify-center text-sm text-slate-500">Carregando acesso…</div>}>
      <LoginContent />
    </Suspense>
  );
}
