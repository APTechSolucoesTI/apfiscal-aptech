...
export const Route = createFileRoute("/_authenticated/dashboard")({
  ...
  head: () => ({
    meta: [
      { title: "Dashboard de Status NF-e | APFiscal" },
      {
        name: "description",
        content:
          "Acompanhe as NF-e por status de aprovação: pendentes de confirmação, aprovadas, prontas para integração e integradas na TOTVS.",
      },
      { property: "og:title", content: "Dashboard de Status NF-e | APFiscal" },
      {
        property: "og:description",
        content: "Resumo das NF-e por status de aprovação no APFiscal.",
      },
