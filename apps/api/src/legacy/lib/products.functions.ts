...
export const getProduct = createApiAction({ method: "GET" })
  .middleware([requireSupabaseAuth])
...
export const saveProduct = createApiAction({ method: "POST" })
  .middleware([requireSupabaseAuth])
...
export const deleteProduct = createApiAction({ method: "POST" })
  .middleware([requireSupabaseAuth])
  .inputValidator((data: { id: string }) => data)
  .handler(async ({ data, context }) => {
...
export const deleteProducts = createApiAction({ method: "POST" })
  .middleware([requireSupabaseAuth])
...
export const getNextProductCode = createApiAction({ method: "GET" })
  .middleware([requireSupabaseAuth])
...
export const listProductSuppliers = createApiAction({ method: "GET" })
  .middleware([requireSupabaseAuth])
...
export const saveProductSupplier = createApiAction({ method: "POST" })
  .middleware([requireSupabaseAuth])
...
export const deleteProductSupplier = createApiAction({ method: "POST" })
  .middleware([requireSupabaseAuth])
  .inputValidator((data: { id: string }) => data)
  .handler(async ({ data, context }) => {
...
export const linkNfeItemToProduct = createApiAction({ method: "POST" })
  .middleware([requireSupabaseAuth])
...
export const unlinkNfeItem = createApiAction({ method: "POST" })
  .middleware([requireSupabaseAuth])
...
export const getNfeItemLinkContext = createApiAction({ method: "GET" })
  .middleware([requireSupabaseAuth])
  .inputValidator((data: { itemId: string }) => data)
  .handler(async ({ data, context }) => {
    const { data: item, error: iErr } = await context.supabase
...
export const searchProductsForLink = createApiAction({ method: "GET" })
  .middleware([requireSupabaseAuth])
...
export const createProductAndLinkItem = createApiAction({ method: "POST" })
  .middleware([requireSupabaseAuth])
