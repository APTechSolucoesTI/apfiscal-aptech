  ...
  apfiscal: {
    Tables: {
      ...
      documentos_fiscais_integracao: {
        Row: {
          ...
          status: Database["apfiscal"]["Enums"]["doc_integracao_status"]
      ...
      empresa_integracoes_fiscais: {
        Row: {
          ...
          apifiscal_certificate_configured: boolean
          apifiscal_certificate_last_error: string | null
          apifiscal_certificate_updated_at: string | null
          ativo: boolean
      ...
      fiscal_distribution_state: {
        ...
        Relationships: [
          {
            foreignKeyName: "fiscal_distribution_state_company_id_fkey"
            columns: ["company_id"]
            referencedRelation: "companies"
            referencedColumns: ["id"]
          },
      ...
      fiscal_documents: {
        Row: {
          ...
          status: Database["apfiscal"]["Enums"]["nfe_status"]
      ...
      nfe_status_historico: {
        Row: {
          ...
          status_anterior: Database["apfiscal"]["Enums"]["nfe_status"] | null
          status_novo: Database["apfiscal"]["Enums"]["nfe_status"]
        }
        Insert: {
          alterado_em?: string
          alterado_por?: string | null
      ...
      organization_members: {
        Row: {
          ...
          role: Database["apfiscal"]["Enums"]["app_role"]
          user_id: string
        }
        Insert: {
          active?: boolean
    ...
    Functions: {
      ...
      has_org_role: {
        Args: {
          _org_id: string
          _roles: Database["apfiscal"]["Enums"]["app_role"][]
        }
        Returns: boolean
      }
      ...
      release_fiscal_sync_lock: {
        Args: { _company_id: string; _lock_token: string }
        Returns: undefined
      }
      try_acquire_fiscal_sync_lock: {
        Args: { _company_id: string; _ttl?: string; _worker_id: string }
        Returns: string
      }
