...
export const listClassifications = createApiAction({ method: "GET" })
...
export const saveClassification = createApiAction({ method: "POST" })
  .middleware([requireSupabaseAuth])
...
export const deleteClassification = createApiAction({ method: "POST" })
  .middleware([requireSupabaseAuth])
